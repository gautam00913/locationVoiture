                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                      <form action=" {{ route('admin_categories.store') }} " method="POST" class="p-2">
                        ...
                        <div class="my-2">
                            ...
                            <input type="text" name="name" class="w-full border rounded-lg  @error('name') border-red-400 @else border-blue-200 @enderror">
                            @error('name')
                        ...
                        <div class="mt-5">
                            <button type="submit" class="bg-red-600 text-white rounded-lg p-2 w-full">Ajouter</button>
                        </div>
                    </form>
                 </div>
            </div>
